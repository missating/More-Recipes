      ...
      <div className="row">
        ...
        <div className="col-md-4 intro-text">
          ...
          <p>
            ...
            More-Recipes and get feedback in form of reviews and votes from
            other users who explore that recipe.
          </p>
          <p>
            {' '}
            Users can also keep a list of their f avorite recipes on the
            application.
          </p>
          {!props.authenticated && (
            <p>
