...
export const RECEIVE_USER_RECIPES_ERROR = 'RECEIVE_USER_RECIPES_ERROR';

export const RECEIVE_USER_FAVOURITE = 'RECEIVE_USER_FAVOURITE';
export const RECEIVE_USER_FAVOURITE_ERROR = 'RECEIVE_USER_FAVOURITE_ERROR';
